...
selected_maps = act.get_ymap_index_act_selected(deprotype='cib_cibdBeta',beta_range=[1.0,1.2],T_range=[10.0,12.0],verbose=True)
...
ymap_enmap = selected_maps[0].read_map_to_enmap()
...
np.savetxt(outpath+'cibdbeta_yy_results.txt',np.array([ells,cl_yy[0]]).T,header='ell cl_yy')
